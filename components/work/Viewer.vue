<template>
  <div class="container">
    <hooper :settings="options" style="height: auto; width: 100%;">
      ...
      >
        <you-tube
          v-if="mediaAsset.youtube_video_id !== null"
          :youtubeID="mediaAsset.youtube_video_id"
        />
        <image-asset v-if="mediaAsset.image !== null" :src="mediaAsset.image" />
        <sound-cloud
          v-if="mediaAsset.soundcloud_embed_html !== ''"
          :soundcloudEmbedHTML="mediaAsset.soundcloud_embed_html"
        />
        <sketchfab
          v-if="mediaAsset.sketchfab_embed_html !== ''"
          :sketchfabEmbedHTML="mediaAsset.sketchfab_embed_html"
        />
      </slide>
...
.hooper-next svg:hover,
.hooper-prev svg:hover {
